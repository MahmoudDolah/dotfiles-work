...
alias docker-stop-all="docker ps -q | xargs docker stop ; docker system prune -a"
...
# get current relative dir from git and copy to clipboard
alias pwdgit='git rev-parse --show-prefix | gtee "$(tty)" | pbcopy'
# get times for salah
